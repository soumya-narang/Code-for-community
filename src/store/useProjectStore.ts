...
export type Status = 'Proposed' | 'In Progress' | 'Completed';
...
const seedProjects: Project[] = [
  ...
  },
  {
    ...
    submissions: [
      ...
      { id: 's5', text: 'Playground is not well maintained.', timestamp: '1 week ago' }
    ]
  },
  {
    id: 'p3',
    ...
    statusJustification: 'Contractor assigned, work to begin next week.',
    signals: [
  ...
  },
  {
    ...
    statusJustification: 'New PVC pipelines laid and pressure tested successfully.',
    signals: [
  ...
  {
    id: 'p6',
    theme: 'Streetlight Installation',
    ward: 'Ward 4',
    category: 'Electricity',
    score: 55,
    submissionCount: 8,
    justification: 'Moderate safety concern raised by residents. Crime data in the specific blocks does not show a severe spike, placing it at mid-priority.',
    status: 'Proposed',
    lastUpdated: new Date(Date.now() - 1000 * 60 * 60 * 4).toISOString(),
    signals: [
      { label: "Citizen complaint volume", value: 15, color: "bg-slate" },
      { label: "Urgency / sentiment", value: 50, color: "bg-slate" },
      { label: "Demand-gap (public data)", value: 30, color: "bg-slate" },
      { label: "Recency / trend", value: 45, color: "bg-slate" },
    ],
    submissions: [
      { id: 's10', text: 'It is very dark near the park after 7 PM. Women feel unsafe.', timestamp: '3 weeks ago' }
    ]
  }
];
